...
$mng_users = query("SELECT * FROM user");
...
<head>
    ...
    <title>Chariot - Menej User</title>
</head>
                ...
                <div class="col-2">
                    <section class="kanan">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active mb-2" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Member</a>
                        </div>
                    </section>
                </div>
                <div class="col-10">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="col-12">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active profile-akun-adm" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Data Member
                                        </a>
                                    </li>
                                </ul>
                                <!-- Akhir Menu Atas -->
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        ...
                                        <?php endif; ?>
                                        <?php if (isset($_SESSION["blockirUser"])) : ?>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="alert alert-success" role="alert">
                                                        User berhasil diblokir</div>
                                                </div>
                                            </div>
                                            <?php unset($_SESSION["blockirUser"]); ?>
                                        <?php endif; ?>
                                        <?php if (isset($_SESSION["aktivUser"])) : ?>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="alert alert-success" role="alert">
                                                        User berhasil diaktivkan</div>
                                                </div>
                                            </div>
                                            <?php unset($_SESSION["aktivUser"]); ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <small>Banyak anggota : <?= count(query("SELECT * FROM user")) - 1; ?></small>
                                                ...
                                                <table class="table">
                                                    <thead class="thead">
                                                        <tr>
                                                            ...
                                                            <th scope="col" style="width: 260px;">Tindakan</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php $i = 1 - 1; ?>
                                                        <?php foreach ($mng_users as $mng_user) : ?>
                                                            <?php if ($mng_user['role_id'] == 2) : ?>
                                                                <tr>
                                                                    <th scope="row"><?= $i; ?></th>
                                                                    <td><?= $mng_user['name']; ?></td>
                                                                    <?php if ($mng_user['is_active'] == 1) : ?>
                                                                        <td style="color: green;">Aktiv</td>
                                                                    <?php else : ?>
                                                                        <td style="color: red;">Tidak Aktiv</td>
                                                                    <?php endif; ?>
                                                                    <td>
                                                                        <?php if ($mng_user['is_active'] == 2) : ?>
                                                                            <a href="admin-aktiv-user.php?email=<?= $mng_user['email']; ?>" class="btn btn-success">Aktiv</a>
                                                                        <?php else : ?>
                                                                            <a href="admin-blockir-user.php?email=<?= $mng_user['email']; ?>" class="btn btn-warning">Blokir</a>
                                                                        <?php endif; ?>
                                                                        <a href="admin-delete-user.php?email=<?= $mng_user['email']; ?>" class="btn btn-danger hapus">Hapus</a>
                                                                    </td>
                                                                </tr>
                                                            <?php endif; ?>
                                                            <?php $i++; ?>
