...
$bukti_pembayaran = query("SELECT bukti_transaksi FROM user_transaksi WHERE id_transaksi = '$id_transaksi'")[0];
...
<head>
    ...
    <title>Chariot - Bukti Pembayaran</title>
</head>
...
<body>
    ...
    <div class="profile">
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-4">
                    <h2 class="mt-4">Bukti Transfer</h2>
                </div>
            </div>
            <!-- Menu -->
            <div class="row">
                <div class="col-2">
                    <section class="kanan">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active mb-2" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Bukti Transfer</a>
                        </div>
                    </section>
                </div>
                <div class="col-10">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="col-12">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active profile-akun-keu" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Photo bukti
                                        </a>
                                    </li>
                                </ul>
                                <!-- Akhir Menu Atas -->
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <img src="../../../public_html/images/bukti/<?= $bukti_pembayaran['bukti_transaksi']; ?>" alt="" class="mt-3">
                                            </div>
                                        </div>
                                    </div>
                                </div>
