...
<head>
    ...
    <title>Chariot - Metode Pembayaran</title>
</head>
        ...
        <div class="container">
            <section class="pembayaran">
                        ...
                        <div class="card-header" id="headingOne">
                            <h2 class="mb-0">
                                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <img src="../../../public_html/images/material/payment.png" alt="" class="mr-2" width="30px">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="row mb-3 ml-5">
                                                <div class="col-lg-1">
                                                    <img src="../../../public_html/images/material/payment-bca.png" alt="">
                                                </div>
                                                <div class="col-lg-11">
                                                    <li><a href="user-payment-struk.php?method=BCA" # class="ml-2 bca">Bank BCA</a></li>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="row ml-5 bni">
                                                <div class="col-lg-1">
                                                    <img src="../../../public_html/images/material/payment-bni.png" alt="">
                                                </div>
                                                <div class="col-lg-11">
                                                    <li><a href="user-payment-struk.php?method=BNI" class="ml-2 bni">Bank BNI</a></li>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row kembali">
                    <div class="col-lg-12">
                        <a href="cart.html" class="float-right">Kembali</a>
                    </div>
                </div>
            </section>
        </div>
