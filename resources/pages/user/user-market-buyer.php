...
$items = query("SELECT * FROM item_market WHERE id_market = '$id_market'");
                ...
                <div class="col-2">
                    <section class="kanan">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link mb-2" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Toko
                                saya</a>
                            <a class="nav-link active" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Barang</a>
                        </div>
                    </section>
                </div>
                <div class="col-10">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link barang-toko" id="pills-barang-tab" data-toggle="pill" href="#pills-barang" role="tab" aria-controls="pills-barang" aria-selected="true">Barang</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active beli-toko" id="pills-pembeli-tab" data-toggle="pill" href="#pills-pembeli" role="tab" aria-controls="pills-pembeli" aria-selected="false">Pembeli</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade" id="pills-barang" role="tabpanel" aria-labelledby="pills-barang-tab">
                                    <div class="table-min">
                                ...
                                <div class="tab-pane fade show active" id="pills-pembeli" role="tabpanel" aria-labelledby="pills-pembeli-tab">
                                    <div class="table-min">
                                    ...
                                    <div class="pagination">
                                        <?php if ($halamanAktif2 > 1) : ?>
                                            <ul>
                                                <li>
                                                    <a href="?halamanPembeli=<?= $halamanAktif2 - 1 ?>">&laquo;</a>
                                                </li>
                                            </ul>
                                        <?php endif; ?>
                                        ...
                                        <?php for ($i = 1; $i <= $jumlahHalaman2; $i++) : ?>
                                            <?php if ($i == $halamanAktif2) : ?>
                                                <li>
                                                    <a href="?halamanPembeli=<?= $i ?>" class="active"><?= $i ?></a>
                                                </li>
                                            <?php else : ?>
                                                <li>
                                                    <a href="?halamanPembeli=<?= $i ?>"><?= $i ?></a>
                                                </li>
                                            <?php endif; ?>
                                        <?php endfor; ?>
                                        ...
                                        <?php if ($halamanAktif2 < $jumlahHalaman2) : ?>
                                            <ul>
                                                <li>
                                                    <a href="?halamanPembeli=<?= $halamanAktif2 + 1 ?>">&raquo;</a>
                                                </li>
                                            </ul>
                                        <?php endif; ?>
                                    </div>
