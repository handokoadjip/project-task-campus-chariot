...
$_SESSION['user_item'] = $_GET['user_item'];

$item = query("SELECT * FROM item_market WHERE id_item = '$_SESSION[user_item]'")[0];
...
if (isset($_POST['editItem'])) {
    ...
    if (empty($_POST['item_description'])) {
        $error['item_description'] = 'Alamat tidak boleh kosong';
    }
}

if (isset($_POST["editItem"]) && !empty($_POST['item_name']) && !empty($_POST['item_type']) && !empty($_POST['item_price']) && !empty($_POST['item_stock']) && !empty($_POST['item_description'])) {
    if (editItem($_POST) > 0) {
...
<head>
    ...
    <title>Chariot - Ubah Barang</title>
</head>
                    ...
                    <div class="col-lg-12 file-photo">
                        <div class="form-row justify-content-center">
                            <div class="form-group col-md-5 box mr-3">
                                ...
                                <img src="../../../public_html/images/item/<?= $item['item_image']; ?>" width="450px" class="ml-2">
                            </div>
                            <div class="form-group col-md-5 box">
                                <!-- INPUT HIDDEN -->
                                <input type="hidden" name="id_item" value="<?= $item['id_item']; ?>">
                                <input type="hidden" name="id_market" value="<?= $item['id_market']; ?>">
                                <input type="hidden" name="item_image_old" value="<?= $item['item_image']; ?>">
                                <input type="hidden" name="item_created" value="<?= $item['item_created']; ?>">
                                <!-- AKHIR INPUT HIDDEN -->
                                <div class="row">
                                    <div class="col-lg">
                                        <label for="nama-barang">Nama Barang</label>
                                        <input type="text" class="form-control" id="nama-barang" name="item_name" value="<?= $item['item_name'] ?>" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        ...
                                        <input type="text" class="form-control" id="type-barang" name="item_type" value="<?= $item['item_type'] ?>" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        ...
                                        <input type="text" class="form-control" id="harga-barang" name="item_price" value="<?= $item['item_price'] ?>" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        ...
                                        <input type="text" class="form-control" id="stock-barang" name="item_stock" value="<?= $item['item_stock'] ?>" autocomplete="off">
                                        <small class="text-danger pl-3"><?= isset($error['item_stock']) ? $error['item_stock'] : '';  ?></small>
                                    </div>
                                </div>
                                ...
                                <select class="form-control" id="kategori-barang" name="item_category">
                                    <?php foreach ($data["kategoris"] as $kategori) : ?>
                                        <?php if ($item['item_category'] == $kategori) : ?>
                            ...
                            <div class="bg">
                                <div class="form-group col-md-12 box">
                                    ...
                                    <textarea class="form-control" id="detail-barang" class="mt-2" rows="3" name="item_description"><?= $item['item_description']; ?></textarea>
                                    <small class="text-danger pl-3"><?= isset($error['item_description']) ? $error['item_description'] : '';  ?></small>
                                </div>
                            </div>
                            <div class="col-md-10 mt-3">
                                <button type="submit" class="btn btn-warning float-right" name="editItem">Simpan</button>
