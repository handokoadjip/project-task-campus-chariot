                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="col-12">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active profile-akun" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Profile Anda
                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 profiles">
                                                ...
                                                <p> <?= $user['birth']; ?> </p>
                                                <p> <?= $user['address']; ?></p>
                                                <p> <?= waktu_lalu($user['date_created']); ?></p>
                                            </div>

                                            <div class="col-lg-4 images ">
                                                <img src="../../../public_html/images/profile/<?= $user['image']; ?>" alt="..." width="250px" height="250px" style="border: 1px solid #ddd;">
                                            </div>

                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <a href="user-profile-edit.php" class="btn btn-warning font-weight-bold mt-5">Ubah
                                                        Profile</a>
                                                </div>
                                            </div>
                                        </div>
