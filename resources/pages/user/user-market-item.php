                                    ...
                                    <div class="row">
                                        ...
                                        <div class="pagination">
                                            <?php if ($halamanAktif1 > 1) : ?>
                                                <ul>
                                                    <li>
                                                        <a href="?halamanBarang=<?= $halamanAktif1 - 1 ?>">&laquo;</a>
                                                    </li>
                                                </ul>
                                            <?php endif; ?>
                                            ...
                                            <?php for ($i = 1; $i <= $jumlahHalaman1; $i++) : ?>
                                                <?php if ($i == $halamanAktif1) : ?>
                                                    <li>
                                                        <a href="?halamanBarang=<?= $i ?>" class="active"><?= $i ?></a>
                                                    </li>
                                                <?php else : ?>
                                                    <li>
                                                        <a href="?halamanBarang=<?= $i ?>"><?= $i ?></a>
                                                    </li>
                                                <?php endif; ?>
                                            <?php endfor; ?>
                                            ...
                                            <?php if ($halamanAktif1 < $jumlahHalaman1) : ?>
                                                <ul>
                                                    <li>
                                                        <a href="?halamanBarang=<?= $halamanAktif2 + 1 ?>">&raquo;</a>
                                                    </li>
                                                </ul>
                                            <?php endif; ?>
                                        </div>
                                            ...
                                            <section class="pembeli mb-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5 alamat-pembeli">
                                                        ...
                                                        <p>status pembayaran <a href=""><?= $pembeli['payment_transaksi']; ?> </a></p>
                                                        <p>status barang <a href=""><?= $pembeli['status_transaksi']; ?></a></p>
                                                    </div>
                                                </div>
                                            </section>
                                        <?php endforeach; ?>
