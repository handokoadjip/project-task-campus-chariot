...
$sukses = "SELECT `user_transaksi`.*, `user_market`.`market_name`, `item_market`.`item_name`, `item_market`.`item_type`, `item_market`.`item_image`
FROM `user_market` join `item_market` ON `user_market`.`id_market` = `item_market`.`id_market`
join `user_transaksi` ON `item_market`.`id_item` = `user_transaksi`.`id_item` 
WHERE `user_transaksi`.`email` = '$email' AND `user_transaksi`.`status_transaksi` = 'sukses' LIMIT $awalData2, $jumlahDataPerHalaman";

$querys = mysqli_query($conn, $sukses);
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="col-12">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active antri-pesan" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Pembelian</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link batal-pesan" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Sukses</a>
                                    </li>
                                </ul>
                                <!-- Akhir Menu Atas -->
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        <div class="table-min">
                                            ...
                                            <?php endif; ?>
                                            <?php if (isset($_SESSION["bukti_transaksi"])) : ?>
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="alert alert-success" role="alert">
                                                            Bukti transaksi sudah di upload</div>
                                                    </div>
                                                </div>
                                                <?php unset($_SESSION["bukti_transaksi"]); ?>
                                            <?php endif; ?>
                                            <?php while ($transaksi = mysqli_fetch_assoc($query)) : ?>
                                                <div class="row mb-3">
                                                    <div class="col-lg-2">
                                                        <a href="user-item-detail.php?id_item=<?= $transaksi['id_item']; ?>"><img src="../../../public_html/images/item/<?= $transaksi['item_image']; ?>" alt="..." class="img-thumbnail item-para"></a>
                                                    </div>
                                                    <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-3 mt-4">
                                                        <p class="mt-2">Tanggal : <?= $transaksi['date_transaksi']; ?></p>

                                                        <?php if ($transaksi['bukti_transaksi'] != '-') : ?>
                                                            <p class="mt-3">Upload pembayaran <span class="fas fa-check" style="color: green;"></span></p>
                                                        <?php else : ?>
                                                            <p class="mt-3">Upload pembayaran</p>
                                                        <?php endif; ?>
                                                        <a href="user-upload-item-bukti.php?id_transaksi=<?= $transaksi['id_transaksi']; ?>">Klik disini</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        ...
                                                        <?php if ($transaksi['payment_transaksi'] == 'pending') : ?>
                                                            <p class="mt-2">Status pembayaran <span style="color:red;">pending</span></p>
                                                        <?php else : ?>
                                                            <p class="mt-2">Status pembayaran <span style="color:green;">sukses</span></p>
                                                        <?php endif; ?>

                                                        <?php if ($transaksi['item_transaksi'] == 'pending') : ?>
                                                            <p class="mt-2">status barang <span style=" color:red">pending</span></p>
                                                        <?php elseif ($transaksi['item_transaksi'] == 'dikirim') : ?>
                                                            <p class="mt-2">status barang <span style="color:blue;">dalam pengiriman</span></p>
                                                        <?php else : ?>
                                                            <p>status barang <span style="color:green">diterima</span></p>
                                                        <?php endif; ?>

                                                        <?php if ($transaksi['item_transaksi'] == 'dikirim') : ?>
                                                            <p class="mt-2"><a href="user-market-buyer-accept.php?id_transaksi=<?= $transaksi['id_transaksi']; ?>" class="btn btn-primary">Terima barang</a></p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            <?php endwhile; ?>
                                        ...
                                        <div class="pagination">
                                            <?php if ($halamanAktif1 > 1) : ?>
                                                <ul>
                                                    <li>
                                                        <a href="?halamanPembelian=<?= $halamanAktif1 - 1 ?>">&laquo;</a>
                                                    </li>
                                                </ul>
                                            <?php endif; ?>
                                            ...
                                            <?php for ($i = 1; $i <= $jumlahHalaman1; $i++) : ?>
                                                <?php if ($i == $halamanAktif1) : ?>
                                                    <li>
                                                        <a href="?halamanPembelian=<?= $i ?>" class="active"><?= $i ?></a>
                                                    </li>
                                                <?php else : ?>
                                                    <li>
                                                        <a href="?halamanPembelian=<?= $i ?>"><?= $i ?></a>
                                                    </li>
                                                <?php endif; ?>
                                            <?php endfor; ?>
                                            ...
                                            <?php if ($halamanAktif1 < $jumlahHalaman1) : ?>
                                                <ul>
                                                    <li>
                                                        <a href="?halamanPembelian=<?= $halamanAktif1 + 1 ?>">&raquo;</a>
                                                    </li>
                                                </ul>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        ...
                                        <div class="table-min">
                                            <?php while ($suks = mysqli_fetch_assoc($querys)) : ?>
                                                <div class="row mb-3">
                                                    <div class="col-lg-2">
                                                        <a href="rinci-barang.html"><img src="../../../public_html/images/item/<?= $suks['item_image']; ?>" alt="..." class="img-thumbnail item-para"></a>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <h3 class="font-weight-bold"><?= $suks['item_name']; ?></h3>
                                                        <p><?= $suks['item_type']; ?><span> | <?= $suks['many_transaksi']; ?> item</span></p>
                                                        <p class="harga-para mt-4">Harga : Rp. <span class="harga-barang"><?= $suks['price_transaksi']; ?></span></p>
                                                    </div>
                                                    <div class="col-lg-3 tngl-pesan">
                                                        <p>Tanggal : </p>
                                                        <p><?= $suks['date_transaksi']; ?> </p>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <p>Keterangan tambahan</p>
                                                        <textarea name="" id="" cols="30" rows="2" readonly><?= $suks['info_transaksi']; ?></textarea>
                                                        <p>status barang <span style="color:green;"><?= $suks['status_transaksi']; ?></span></p>
                                                    </div>
                                                </div>
                                            <?php endwhile; ?>
                                        </div>
                                        ...
                                        <div class="pagination">
                                            <?php if ($halamanAktif2 > 1) : ?>
                                                <ul>
                                                    <li>
                                                        <a href="user-history-delivery-success.php?halamanSukses=<?= $halamanAktif2 - 1 ?>">&laquo;</a>
                                                    </li>
                                                </ul>
                                            <?php endif; ?>
                                            ...
                                            <?php for ($i = 1; $i <= $jumlahHalaman2; $i++) : ?>
                                                <?php if ($i == $halamanAktif2) : ?>
                                                    <li>
                                                        <a href="user-history-delivery-success.php?halamanSukses=<?= $i ?>" class="active"><?= $i ?></a>
                                                    </li>
                                                <?php else : ?>
                                                    <li>
                                                        <a href="user-history-delivery-success.php?halamanSukses=<?= $i ?>"><?= $i ?></a>
                                                    </li>
                                                <?php endif; ?>
                                            <?php endfor; ?>
                                            ...
                                            <?php if ($halamanAktif2 < $jumlahHalaman2) : ?>
                                                <ul>
                                                    <li>
                                                        <a href="user-history-delivery-success.php?halamanSukses=<?= $halamanAktif2 + 1 ?>">&raquo;</a>
                                                    </li>
                                                </ul>
                                            <?php endif; ?>
                                        </div>
