                    ...
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="col-12">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link antri-pesan" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                                        <h4>Masuk</h4>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active batal-pesan" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                                        <h4>Daftar</h4>
                                    </a>
                                </li>
                            </ul>
                                        ...
                                        <div class="col-md-8 form-log mt-5">
                                            <form action="" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="alamat-email" name="email-login" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-log mt-5">
                                            <form action="" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="alamat-email" class="mt-3">Alamat Email</label>
                                                    <input type="text" class="form-control" id="alamat-email" name="email" autocomplete="off">
